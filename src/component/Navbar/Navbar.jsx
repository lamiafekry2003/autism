    ...
    <nav className="bg-white  w-full fixed z-40">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 w-10 h-10  sm:mx-3 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
