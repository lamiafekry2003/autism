...
export default function About() {
  ...
  return (
    <div className="">
      <div className="mx-auto py-10 lg:min-h-[550px]">
        <div className="flex flex-col justify-center items-center h-56 relative">
          <img
            src={img}
            alt="About Background"
            className="w-full object-cover"
          />
          <h2 className="absolute inset-0 lg:top-[50%] flex justify-center items-center text-center text-3xl lg:text-5xl font-bold text-blue-500 opacity-40">
            About
          </h2>
        </div>
      </div>
      {/* two */}
      <div className="mx-auto py-7 lg:py-12">
        <div className="flex flex-col lg:flex-row lg:gap-12 justify-center items-center">
          ...
          whileInView="show"
          viewport={{ once: false, amount: 0.7 }}
          className="order-2 lg:order-1 mt-8 lg:mt-0 max-w-xs  md:max-w-sm lg:max-w-md tracking-wider px-4 lg:px-0">
            <h2 className="text-2xl lg:text-4xl my-2 font-bold">
              Our Websites Goal is
            </h2>
            <h2 className="text-2xl lg:text-4xl my-2 font-bold">
            ...
            <p className="text-slate-500  leading-9 max-w-md ml-2">
          ...
          <div 
          className="order-1 lg:order-2 w-full lg:w-auto lg:mt-10 lg:ml-5">
            <img
              src={img3}
              alt="About Image"
              className="w-80 lg:w-96 h-[600px] object-cover rounded-md mx-auto"
            />
          </div>
        </div>
      </div>
      {/* three */}
      <div className="mx-auto py-10 lg:px-10 min-h-[550px] bg-gray-100">
      <motion.div
      variants={fedIn('up', 0.2)}
      initial="hidden"
      whileInView="show"
